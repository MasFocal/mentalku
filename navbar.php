<div class="header">
    ...
    <div class="navbar">
        ...
        -->
        <a id="menu" href="404.php"><button class="button-login" id="btn-login">Login</button></a>
        <div class="bars">
    ...
    <div class="dropdown">
        ...
        <a href="404.php">Profile</a>
        -->
        <li><a id="menu" href="404.php"><button class="button-login" id="btn-login">Login</button></a></li>
    </div>
    <script>
